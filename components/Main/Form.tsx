  ...
  return (
    <div className='mt-[80px] 2xl:mt-[200px]'>
        <div className=' bg-[#222E51] py-[40px] px-[16px] 2xl:py-[100px] 2xl:px-[50px]  4xl:px-[240px] flex flex-col 2xl:flex-row'>
            {/* TEXT AND BUTTON */}
            <div className='w-[60%]'>
                    <p className='text-[26px] 2xl:text-[50px] 2xl:leading-[62px]  uppercase text-titleWhite font-jost leading-[32px]'>Станьте частью <br className='2xl:hidden'/> сообщества <br/> архитекторов <br className='2xl:hidden'/> будущего!</p>
                    <p className='mt-[10px] 2xl:mt-[20px] 2xl:w-[50%] text-[15px] leading-[18px] text-[#A0A0A0]'>Присоединяйтесь к нам, чтобы вместе создавать проекты, которые вдохновляют и меняют города к лучшему</p>
            ...
            <div className='mt-[30px] flex items-center gap-[8px] justify-center w-[40%] 2xl:items-end 2xl:mt-[220px] 2xl:ml-[-80px]'>
