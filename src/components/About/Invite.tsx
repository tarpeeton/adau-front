                                    ...
                                    <div className='relative 2xl:flex 2xl:flex-row 2xl:justify-between'>
                                        ...
                                        <div className='mt-[30px] flex flex-col gap-[20px] 2xl:w-[48%] 2xl:gap-[40px] 2xl:mt-0'>
                                            ...
                                            {item.options.map((item, index) => (
                                                <p key={index} className='pb-[20px] 2xl:mt-[20px] border-b border-b-[#E4E4E4] text-[18px] font-bold text-[#414141] leading-[22px] 2xl:pb-[20px] 2xl:leading-[30px] 2xl:text-[22px] 2xl:text-titleDark'>
                                                    {item.name[locale]}
                                                </p>
                                            ))}
