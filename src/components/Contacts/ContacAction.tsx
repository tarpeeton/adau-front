          ...
          <p className='mt-[10px] 2xl:mt-[20px] 2xl:w-[50%] text-[15px] leading-[18px] text-white opacity-[80%]'>
            {
              locale === 'ru'
                ...
                : locale === 'uz'
                  ? "Loyihangiz yoki hamkorlikni muhokama qilish uchun biz bilan bog‘laning. Biz barcha savollaringizga javob beramiz"
                  : "Contact us to discuss your project or collaboration. We will answer all your questions"
            }

          </p>
          <div className='flex flex-row flex-nowrap justify-between mt-[25px] 2xl:w-[45%] 2xl:mt-[50px]'>
            <Link href='/telegram' className='buttonWhite w-[55%]'>
              {
                locale === 'ru'
                  ? "Написать нам"
                  : locale === 'uz'
